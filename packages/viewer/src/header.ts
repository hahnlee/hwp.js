...
/*
 * LICENSE FOR Google Material Icons
 *
                                 Apache License
...
class Header {
  ...
  drawInfoIcon() {
    ...
    button.innerHTML = '<div class="hwpjs-header-control"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M11 7h2v2h-2zm0 4h2v6h-2zm1-9C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/></svg></div>'
    button.addEventListener('click', this.handleInfoButtionClick)
  ...
  drawPresentationIcon() {
    ...
    button.style.height = '100%'
    button.style.padding = '2px'
    button.innerHTML = '<div class="hwpjs-header-control"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M10 8v8l5-4-5-4zm9-5H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14z"/></svg></div>'
    button.addEventListener('click', this.handlePresentationButtionClick)
    this.container.appendChild(button)
  ...
  drawPrintIcon() {
    ...
    button.style.height = '100%'
    button.style.padding = '2px'
    button.innerHTML = '<div class="hwpjs-header-control"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 8h-1V3H6v5H5c-1.66 0-3 1.34-3 3v6h4v4h12v-4h4v-6c0-1.66-1.34-3-3-3zM8 5h8v3H8V5zm8 12v2H8v-4h8v2zm2-2v-2H6v2H4v-4c0-.55.45-1 1-1h14c.55 0 1 .45 1 1v4h-2z"/><circle cx="18" cy="11.5" r="1"/></svg></div>'
    button.addEventListener('click', this.handlePrintButtionClick)
    this.container.appendChild(button)
